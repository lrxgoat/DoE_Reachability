...
func DoH_Verify(Target *metrics.Result, sni, iptype, httpVer, httpMethod string) (bool, string, string) {
	...
	if dnserr != nil {
		return false, metrics.WriteResult(Target, "Response", "Conn: "+dnserr.Error()) + "\n", certResult
	}
